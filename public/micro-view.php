    ...
    <div class="col-md-6">
      <div class="card p-3">
        ...
        <form method="post" class="row g-2">
          ...
          <div class="col-6">
            <label class="form-label mb-1">Fréquence cotisations</label>
          ...
          <div class="col-6">
            ...
            <select name="region" class="form-select form-select-sm">
              <option value="" <?= empty($micro['region'])?'selected':''?>>(Standard)</option>
          ...
          <div class="col-6">
            <label class="form-label mb-1">Réduction ACRE (0-1)</label>
          ...
          <div class="col-12 mt-2">
            ...
            <button name="form" value="refresh_current" class="btn btn-sm btn-outline-secondary ms-2">
              Recalcul période courante
            </button>
          </div>
        </form>
      </div>
