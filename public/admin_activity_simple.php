        ...
        if ($action === 'create' || $action === 'update') {
            ...
            if ($action === 'create') {
                $sql = "INSERT INTO micro_activity_rates
                  ...
                  VALUES
                  (:code,:label,:family,:sr,:ir,:cfp,:ch_type,:ch_def,:ch_al,:ch_mo,:ca,:tva,:tvaM,:tvaThr,datetime('now'))";
            } else {
            ...
            $delId = (int)$_POST['id'];
            $pdo->prepare("DELETE FROM micro_activity_rates WHERE id=:id")->execute([':id'=>$delId]);
    ...
    <div class="card shadow-sm">
      ...
      <div class="card-body">
        <form method="post" class="row g-3">
          ...
          <?php if($isEdit): ?><input type="hidden" name="id" value="<?= (int)$v['id'] ?>"><?php endif; ?>
